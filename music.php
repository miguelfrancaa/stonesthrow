		...
		<div class="container">
			<div class="row shopCat">
				<div class="col-md-6 col-sm-12 col-xs-12 shopCat2 disappear">
					<a href="music.html"><h2 class="name">Music</h2></a>
				</div>
				<div class="col-md-6 col-sm-12 col-xs-12 shopCat2">
					<a href="merch.html"><h2 class="name musicCats">
						<a href="vinyl.html" class="musicCat">Vinyl</a><br>
						<a href="" class="musicCat">CD</a><br>
						<a href="" class="musicCat">45's</a><br>
						<a href="" class="musicCat">Cassete</a><br>
					</h2></a>
				</div>
			</div>
		</div>
